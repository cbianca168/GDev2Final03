...
public class ReadMe : EditorWindow {
    ...
    static void ResetRenderPipeline() {
        ...
        if(hdrp) {
            ...
            var fs = hdrp.currentPlatformRenderPipelineSettings;
            fs.supportVolumetrics = false;

            var miCleanUpRP = typeof(UnityEngine.Rendering.RenderPipelineManager).GetMethod("CleanupRenderPipeline", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Static);
